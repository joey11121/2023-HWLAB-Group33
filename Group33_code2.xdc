...
# Switches
set_property PACKAGE_PIN V17 [get_ports {candy}]
    set_property IOSTANDARD LVCMOS33 [get_ports {candy}]
set_property PACKAGE_PIN V16 [get_ports {open}]
...
set_property PACKAGE_PIN T1 [get_ports {play}]
...
# set_property PACKAGE_PIN N3 [get_ports {motorLED[13]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[13]}]
# set_property PACKAGE_PIN P1 [get_ports {motorLED[14]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[14]}]
# set_property PACKAGE_PIN L1 [get_ports {motorLED[15]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[15]}]
...
## Sch name = JA4
 ...
 #Sch name = JA7
 set_property PACKAGE_PIN H1 [get_ports {IIB}] 
    set_property IOSTANDARD LVCMOS33 [get_ports {IIB}]
## Sch name = JA8 (ENA)
 set_property PACKAGE_PIN K2 [get_ports {IIA}]
    set_property IOSTANDARD LVCMOS33 [get_ports {IIA}]
## Sch name = JA9
 set_property PACKAGE_PIN H2 [get_ports {IB}]
    set_property IOSTANDARD LVCMOS33 [get_ports {IB}]
# Sch name = JA10
 set_property PACKAGE_PIN G3 [get_ports {IA}]
