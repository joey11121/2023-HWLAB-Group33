...
## Sch name = JA9
 set_property PACKAGE_PIN H2 [get_ports {trig0}]
    set_property IOSTANDARD LVCMOS33 [get_ports {trig0}]
## Sch name = JA10
 set_property PACKAGE_PIN G3 [get_ports {echo0}]
...
## Sch name = JB3
 #set_property PACKAGE_PIN B15 [get_ports {trig0}]
   # set_property IOSTANDARD LVCMOS33 [get_ports {trig0}]
## Sch name = JB4
 #set_property PACKAGE_PIN B16 [get_ports {echo0}]
    #set_property IOSTANDARD LVCMOS33 [get_ports {echo0}]
## Sch name = JB7
# set_property PACKAGE_PIN A15 [get_ports {motor_cw[0]}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {motor_cw[0]}]
## Sch name = JB8
# set_property PACKAGE_PIN A17 [get_ports {left_track}]
    #set_property IOSTANDARD LVCMOS33 [get_ports {left_track}]
## Sch name = JB9
 set_property PACKAGE_PIN C15 [get_ports {echo1}]
    set_property IOSTANDARD LVCMOS33 [get_ports {echo1}]
## Sch name = JB10
 set_property PACKAGE_PIN C16 [get_ports {trig1}]
